...
%             dydt(5) = (1 / this.I(1, 1)) * (-(this.I(3, 3) - this.I(2, 2)) * vRot(2) * vRot(3) - this.rw_ang_momentum * vRot(2)+ this.torq(1));
%             dydt(6) = (1 / this.I(2, 2)) * (-(this.I(1, 1) - this.I(3, 3)) * vRot(1) * vRot(3) - this.rw_ang_momentum * vRot(1)+ this.torq(2));
...
%             +this.dt^2/24*[0;cross(vRot,vRot_next)]
